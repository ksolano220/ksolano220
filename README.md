...
Data analyst and product builder. I work across healthcare data, operational analytics, applied AI, and consumer product, with a bias toward projects that answer the "so what" question, not just produce pretty charts.

## Currently

- **Open to full-time roles** in data analytics, product, or AI / ML engineering (NYC-based or remote)
- Founder of [Zona](https://www.getzona.app), a real-time nightlife decision app for iOS
- Shipping portfolio work across healthcare analytics, risk scoring, and applied AI
...
Dual-model governance system where two AI models review each other's work. Self-healing agents, plan execution, and a real-time monitoring dashboard.
...
Multi-agent workflow on IBM watsonx.ai for government benefit claim processing.
...
- **Applied AI:** LoRA fine-tuning, Hugging Face Transformers, PyTorch, multi-agent systems
